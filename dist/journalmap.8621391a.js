...
function initMap() {
  ...
  var vaults = getVaults('test@gmail.com');
  var theKeys = Object.keys(vaults);
  // const coordinatesArray = []
  console.log("hi");
  console.log(theKeys);
  console.log(vaults);
  for (var theKey in theKeys) {
    console.log("inside");
...
function getVaults(_x) {
  return _getVaults.apply(this, arguments);
}
function _getVaults() {
  _getVaults = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(email) {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 9:
          ...
          return _context.abrupt("return", data.result.vaults);
        case 14:
          _context.prev = 14;
